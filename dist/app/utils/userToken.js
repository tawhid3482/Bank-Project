...
const createUserToken = (user) => {
    ...
    const accessToken = (0, jwt_1.generateToken)(jwtPayload, env_1.envVars.JWT_ACCESS_SECRET, env_1.envVars.JWT_EXPIRES_IN);
...
const createNewAccessTokenWithRefreshToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isUserExist) {
        throw new AppError_1.default(http_status_codes_1.default.CONFLICT, "User does not exist");
    }
    if (isUserExist.isActive === user_interface_1.IsActive.BLOCKED ||
        isUserExist.isActive === user_interface_1.IsActive.INACTIVE) {
        throw new AppError_1.default(http_status_codes_1.default.CONFLICT, `User is ${isUserExist.isActive}`);
    }
    if (isUserExist.isDeleted) {
        throw new AppError_1.default(http_status_codes_1.default.CONFLICT, "User is deleted");
    }
    const jwtPayload = {
        id: isUserExist._id,
